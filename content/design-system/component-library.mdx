...
For a library Claude Code may not know well, add 2–3 component examples to DESIGN.md with import paths, props, and usage patterns for buttons, cards, and other primitives.
