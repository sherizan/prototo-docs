...
description: "The legacy two-window flow: Prototo in one Terminal, your coding agent in another."
---
...
Your agent reads DESIGN.md before every generation, so it already knows your colours, typography, spacing, and component library. You never repeat context.

## The complete terminal workflow

```
npx proto start      → Simulator opens       (Window 1, leave it)
cd myapp && claude   → your agent opens      (Window 2, stay here)
