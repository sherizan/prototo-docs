---
title: Prerequisites
description: Install Node.js, Xcode, and Claude Code before creating your first Proto project.
---
...
For better results with Figma files, current Expo APIs, and iOS-native interaction, see [Configure Claude Code](/getting-started/configure-claude-code) — optional, one-time setup.
