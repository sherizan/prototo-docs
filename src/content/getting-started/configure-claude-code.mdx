...
Each person still signs in to Figma and Context7 on their own Mac the first time. See [Share via GitHub](/tips/share-github) if you want the config file in the repo.
