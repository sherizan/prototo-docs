...
Describe a screen in the terminal. Watch it appear on the iPhone beside it. When it looks right, click **Publish** for a live link anyone can open in their browser, or **Record** to send a clip to Studio.
...
npx proto share      → send a live link      (see Share a live preview)
```
