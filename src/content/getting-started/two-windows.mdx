...
Tap to test interactions. Watch it update after every prompt. When it looks right, run `npx proto share` to get a live-preview link anyone can open in their browser. See [Share a live preview](/sharing/share-link).
