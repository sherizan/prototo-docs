...
## In Prototo Desktop: one click

Press **Team** (on the welcome screen, in the title bar, or from the app menu). Everything your team has published is listed there. Press **Remix** on one, pick a folder name, and Prototo Desktop downloads it into `~/Prototo`, sets it up, and opens it as your current project.

## In the terminal: two steps

1. On your team page, find the prototype and press **Remix**. Copy the command it shows.
