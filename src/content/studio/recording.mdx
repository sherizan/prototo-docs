...
With your Simulator running ([Window 1](/getting-started/terminal)), run:
...
<Note>
Record from a booted Simulator — run [`npx proto start`](/getting-started/terminal) first. If nothing is running, Prototo tells you: *"No preview is running yet. Run npx proto start first, then record."*
</Note>
