...
This is a workaround, not a polished share link. The other person needs [Prerequisites](/getting-started/prerequisites) installed (Node.js, Xcode, Claude Code) and a few Terminal commands. It works well for teammates, engineers, or stakeholders who are comfortable on a Mac.
